...
public class Voice {
	...
	static String credentials = "/Users/mengyu/Documents/学习/研究生/OOP-JAVA/作业/ecl/javachatbotfile.json";
	...
	public void voice() throws Exception {
		...
		try (SpeechClient client = SpeechClient.create(speechSettings)) {
			...
			responseObserver = new ResponseObserver<StreamingRecognizeResponse>() {
				ArrayList<StreamingRecognizeResponse> responses = new ArrayList<StreamingRecognizeResponse>();
				...
				public void onComplete() {					
					for (StreamingRecognizeResponse response : responses) {
						...
						results += alternative.getTranscript().toString();						
					}
				}
